...
const Content = (props) => {
  ...
  const {navigation, program, farmData} = props;
  ...
  return (
    <View style={{alignItems:'center', justifyContent:'center', padding: 5}}>
      ...
      <View style={{backgroundColor: '#fff', margin: 5, width: '90%', padding: 5, height: '60%', borderColor: '#090942', borderWidth: 2}}>
        ...
        <View style={styles.secTwo}>
          <Ripple style={styles.submitButton} onPress = {()=>showDialog(program._id)}>
            <Text style={styles.submitText}>شروع باز کردن شیرها</Text>
          </Ripple>
        </View>
        <Dialog.Container
